...
class FormTraitTest extends TestCase
{
    ...
    public function test_formtrait_will_generate_a_form_from_a_db_structure(): void
    {
    ...
    public function test_form_trait_will_generate_a_form_using_extra_mysql_field_data_db_structure(): void
    {
    ...
    public function test_formtrait_form_returns_a_form_object(): void
    {
        $this->assertInstanceOf(\Nickwest\EloquentForms\Form::class, $this->Model->Form());
    }

    public function test_formtrait_getFormView_returns_a_view(): void
    {
    ...
    public function test_formtrait_getFieldView_returns_a_view(): void
    {
    ...
    public function test_formtrait_getFieldDisplayView_returns_a_view(): void
    {
        foreach ($this->Model->Form()->getFields() as $Field) {
    ...
    public function test_formtrait_setAllFormValues_sets_values_to_the_form_from_the_model(): void
    {
    ...
    public function test_formtrait_setPostValues_sets_post_data_to_the_form_and_the_model(): void
    {
        $post_data = $this->getSimulatedPostValues();
        // Id is not fillable
        $post_data['id'] = 100;
    ...
    public function test_formtrait_setPostValues_obeys_model_fillable_settings(): void
    {
        $post_data = $this->getSimulatedPostValues();
    ...
    public function test_fortrait_setPostValues_can_handle_multi_key_fields(): void
    {
        $post_data = $this->getSimulatedPostValues();
    ...
    public function test_formtrait_models_force_validation_on_save_by_default(): void
    {
        $this->assertAttributeEquals(true, 'validate_on_save', $this->Model);
    }

    public function test_formtrait_adds_extra_validation_and_that_works(): void
    {
        $post_data = $this->getSimulatedPostValues();
    ...
    public function test_formtrait_models_validate_on_save_will_run_validation_before_saving(): void
    {
        $post_data = $this->getSimulatedPostValues();
    ...
    public function test_formtrait_models_can_block_validation_on_save(): void
    {
        $post_data = $this->getSimulatedPostValues();
    ...
    public function test_formtrait_save_works_when_form_not_prepared(): void
    {
        $Sample = new Sample;
    ...
    public function test_formtrait_save_works_when_form_not_prepared_but_form_validation_doesnt_work(): void
    {
        $Sample = new Sample;
    ...
    public function test_formtrait_generateFormFromJson_works(): void
    {
