...
class FormTest extends TestCase
{
    ...
    public function test_form_addField_adds_a_field_to_the_form(): void
    {
        // Add the field
    ...
    public function test_form_getField_throws_exception_on_invalid_field(): void
    {
    ...
    public function test_form_addFields_adds_many_fields_to_a_form(): void
    {
    ...
    public function test_form_removeField_removes_a_field_from_the_form(): void
    {
    ...
    public function test_form_removeFields_removes_many_fields_from_the_form(): void
    {
    ...
    public function test_form_isField_returns_existence_of_field(): void
    {
        foreach ($this->fields as $field) {
    ...
    public function test_form_magic_set_method_will_set_field_value(): void
    {
        foreach ($this->fields as $field) {
    ...
    public function test_form_magic_set_method_will_throw_exception_on_invalid_field(): void
    {
        $this->expectException(InvalidFieldException::class);
        $this->Form->notafieldnameatall = 'broken';
    }

    public function test_form_magic_get_method_will_get_field_object(): void
    {
        foreach ($this->fields as $field) {
    ...
    public function test_form_magic_get_method_will_throw_exception_on_invalid_field(): void
    {
        $this->expectException(InvalidFieldException::class);
        $Field = $this->Form->notafieldnameatall;
    }

    public function test_form_magic_isset_method_returns_existence_of_field(): void
    {
        foreach ($this->fields as $field) {
    ...
    public function test_form_addSubForm_adds_a_subform_to_the_form(): void
    {
        $SubForm = new Form();
    ...
    public function test_form_SubForm_fields_are_accessible(): void
    {
    ...
    public function test_form_addSubForm_adds_form_before_specific_field(): void
    {
        $SubForm = new Form();
        $SubForm->addFields(['sub1', 'sub2']);
    ...
    public function test_form_getFieldValues_returns_all_field_values(): void
    {
        $this->assertEquals(array_column($this->fields, 'value', 'name'), $this->Form->getFieldValues());
    }

    public function test_form_setValue_sets_a_fields_value(): void
    {
    ...
    public function test_form_setValue_throws_an_exception_on_invalid_field(): void
    {
        $this->expectException(InvalidFieldException::class);
        $this->Form->setValue('not_a_real_field_at_all', 'abc1234');
    }

    public function test_form_getValue_returns_a_field_value(): void
    {
        foreach ($this->fields as $field) {
    ...
    public function test_form_getValue_throws_an_exception_on_invalid_field(): void
    {
        $this->expectException(InvalidFieldException::class);
        $value = $this->Form->getValue('a_field_that_does_not_exist');
    }

    public function test_form_setValues_sets_multiple_field_values(): void
    {
        // Set all fields to a simple value
    ...
    public function test_form_setValues_throws_an_exception_on_invalid_field(): void
    {
        $values = array_column($this->fields, 'value', 'name');
    ...
    public function test_form_setValues_does_not_throw_an_exception_on_invalid_field_when_ignoring_invalid_fields(): void
    {
        $values = array_column($this->fields, 'value', 'name');
        foreach ($values as $key => $value) {
            $values[$key] = 'zyx4321';
    ...
    public function test_form_setNames_sets_field_name_attribute_on_multiple_fields(): void
    {
    ...
    public function test_form_setTypes_sets_multiple_field_types(): void
    {
    ...
    public function test_form_setTypes_throws_an_exception_on_invalid_field(): void
    {
    ...
    public function test_form_setTypes_allows_CustomField_types_to_be_set(): void
    {
    ...
    public function test_form_setTypes_throws_exception_if_object_is_not_CustomField(): void
    {
    ...
    public function test_form_setExamples_sets_examples_on_multiple_fields(): void
    {
    ...
    public function test_form_setDefaultValues_sets_default_values_on_multiple_fields(): void
    {
    ...
    public function test_form_setDefaultValues_throws_an_exception_on_invalid_field(): void
    {
        $default_values = array_column($this->fields, 'default_value', 'name');
    ...
    public function test_form_setRequiredFields_sets_required_attribute_on_fields(): void
    {
    ...
    public function test_form_setRequiredFields_throws_exception_on_invalid_field(): void
    {
    ...
    public function test_form_setInline_sets_multiple_fields_to_inline(): void
    {
        $field_names = array_slice(array_column($this->fields, 'name'), 0, 3);
    ...
    public function test_form_setInline_throws_exception_on_invalid_field(): void
    {
        $field_names = array_slice(array_column($this->fields, 'name'), 0, 3);
    ...
    public function test_form_setDisplayFields_sets_multiple_fields_for_display(): void
    {
    ...
    public function test_form_setDisplayFields_overwrites_existing_display_fields(): void
    {
        // Field names only (make sure there aren't duplicates)
        $field_names = array_column($this->fields, 'name');
        $field_names = array_combine($field_names, $field_names);
    ...
    public function test_form_setLabels_sets_labels_on_multiple_fields(): void
    {
    ...
    public function test_form_setLabels_throws_exception_on_invalid_field(): void
    {
        $labels = array_column($this->fields, 'label', 'name');
    ...
    public function test_form_setValidationRules_adds_rules_to_fields(): void
    {
    ...
    public function test_form_getValidationn_rules_returns_same_rules_that_are_set(): void
    {
        // Change some validation rules
        $this->validation_rules += [
            $this->fields[6]['name'] => 'required,date,after:tomorrow',
    ...
    public function test_form_setValidationRules_throws_exception_on_invalid_field(): void
    {
        $this->validation_rules += [
            $this->fields[6]['name'] => 'required|date|after:tomorrow',
            $this->fields[7]['name'] => 'exists:connection.staff|email',
    ...
    public function test_form_isValid_can_pass_validation(): void
    {
    ...
    public function test_form_isValid_can_fail_validation(): void
    {
        $this->validation_rules += [
            $this->fields[6]['name'] => 'required|date|after:tomorrow',
            $this->fields[7]['name'] => 'email',
    ...
    public function test_form_isValid_sets_errors_on_invalid_fields(): void
    {
        $this->validation_rules += [
            $this->fields[6]['name'] => 'required|date|after:tomorrow',
            $this->fields[7]['name'] => 'email',
    ...
    public function test_form_has_Attributes(): void
    {
    ...
    public function test_form_Attributes_can_be_set_they_are_public(): void
    {
        $this->Form->attributes->action = 'http://google.com';
        $this->assertEquals($this->Form->attributes->action, 'http://google.com');
    }

    public function test_form_addDatalist_adds_a_datalist_to_the_form_and_sets_it_for_display(): void
    {
    ...
    public function test_form_starts_with_a_save_submit_button(): void
    {
    ...
    public function test_form_addSubmitButton_adds_a_submit_button(): void
    {
    ...
    public function test_form_removeSubmitButton_removes_a_submit_button(): void
    {
        $this->Form->addSubmitButton('resubmit_button', 'Resubmit', 'is-warning');
    ...
    public function test_form_removeSubmitButton_throws_an_exception_when_invalid_name_passed(): void
    {
        $this->expectException(InvalidFieldException::class);
        $Field = $this->Form->getSubmitButton('not_a_button', 'some_value');
    }

    public function test_form_getSubmitButton_gets_a_submit_button(): void
    {
        // Test against the default submit button
        $this->assertInstanceOf(\Nickwest\EloquentForms\Field::class, $this->Form->getSubmitButton('submit_button', 'Submit'));
    }

    public function test_form_getSubmitButton_throws_exception_when_invalid_field_name(): void
    {
        $this->expectException(InvalidFieldException::class);
        $this->Form->getSubmitButton('not_a_field_valid', 'some_value');
    }

    public function test_form_renameSubmitButton_renames_the_button(): void
    {
    ...
    public function test_form_renameSubmitButton_throws_exception_when_invalid_field_name(): void
    {
        $this->expectException(InvalidFieldException::class);
        $this->Form->renameSubmitButton('not_a_field_valid', 'Submit', 'new_field_name');
    }

    public function test_form_renameSubmitButton_throws_exception_when_new_field_name_already_taken(): void
    {
        $this->Form->addSubmitButton('resubmit_button', 'Resubmit', 'is-warning');
    ...
    public function test_form_setTheme_sets_the_theme_on_the_form(): void
    {
    ...
    public function test_form_toJson_creates_valid_json(): void
    {
        // Add a subform
        $subForm = new Form();
        $subForm->addFields(['sub1', 'sub2']);
    ...
    public function test_form_toJson_converts_a_form_to_json_and_back_again(): void
    {
        $json = $this->Form->toJson();
    ...
    public function test_form_can_make_a_view_without_breaking(): void
    {
        $view = $this->Form->MakeView();
        $this->assertInstanceOf(\Illuminate\View\View::class, $view);
    }

    public function test_form_can_make_a_view_and_render_without_breaking(): void
    {
        $view = $this->Form->MakeView();
        $this->assertInstanceOf(\Illuminate\View\View::class, $view);
    ...
    public function test_form_can_make_a_view_and_render_without_breaking_bulma_theme(): void
    {
